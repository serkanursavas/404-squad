...
import { createMatchValidationSchema } from "../../validators/createMatchValidation";
import { initialValues as defaultInitialValues } from "../../forms/createMatchInitialValues";
import { CreateMatchFormData, SelectOption } from "../../types/FormTypes";
...
export default function CreateMatches() {
  const [initialValues, setInitialValues] = useState<CreateMatchFormData>(defaultInitialValues);
  ...
  const handleSubmit = (values: CreateMatchFormData) => {
    if (isEditMode) {
  ...
  return (
    <div className="">
      <Formik
        ...
        validationSchema={createMatchValidationSchema}
        validateOnBlur={true}
