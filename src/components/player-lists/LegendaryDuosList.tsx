...
import { LegendaryDuos } from '../../types/TopListTypes'
import { Zap } from 'lucide-react'

interface LegendaryDuosListProps {
  title: string
...
export default function LegendaryDuosList({ title, statisticLabel, watermark, playersData }: LegendaryDuosListProps) {
          ...
          return (
            ...
            >
              <div className={`flex justify-between py-2 mt-2 text-xs space-x-4 `}>
                ...
                <div className="flex items-center space-x-2 ">
                  <span className="w-12 text-center">{player.gamesTogether}</span>
                </div>
              </div>
            </div>
          )
