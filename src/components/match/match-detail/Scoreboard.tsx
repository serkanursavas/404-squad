...
export default function Scoreboard({ team1, team2, isPlayed }: { team1: Team; team2: Team; isPlayed: boolean }) {
  return (
    <div className="border-2 border-black shadow-pixel">
      <div className="flex items-center justify-between px-2 py-2 text-3xl ">
        ...
        <span className="space-x-1">
          <span>{isPlayed && team1.score}</span>
          <span>-</span>
          <span>{isPlayed && team2.score}</span>
        </span>
        <img
          src={team2.logo}
          alt={team2.name}
